Public Class BillingAPI253Language
    Implements IDisposable
    Public NoPRDetailReasno As String = "停拆機原因細項不存在"
    Public mustDTVPRCode As String = "DTVPRCode需有值!"
    Public mustDTVReasonCode As String = "DTVReasonCode需有值!"
    Public mustCMPRCode As String = "CMPRCode需有值!"
    Public mustCMReasonCode As String = "CMReasonCode需有值!"
