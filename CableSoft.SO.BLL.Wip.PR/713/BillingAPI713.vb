...
Public Class BillingAPI713
    Inherits BLLBasic
    Implements IDisposable, CableSoft.BLL.BillingAPI.IBillingAPI
    Private Language As New CableSoft.BLL.Language.SO61.BillingAPI713Language
    Private _DAL As New BillingAPI713DAL(Me.LoginInfo.Provider)
    Public Sub New()
