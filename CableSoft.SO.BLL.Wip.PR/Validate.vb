...
Imports ValidateLanguage = CableSoft.BLL.Language.SO31.WipPRLanguage
    ...
    Public Function ChkDataOk(ByVal EditMode As EditMode, ByVal WipData As DataSet) As RIAResult
        ...
        Try
            ...
            For Each row As DataRow In PRWipData.Rows
                Dim OldWip As DataTable = DAO.ExecQry(_DAL.CanWipData, row("SNo"), False)
                ...
                If row.IsNull("ResvTime") Then
                    ...
                    Return aRet
                End If
                Dim WipRefNo As Integer = DAO.ExecQry(_DAL.GetCD007, row("PRCode"), False).Rows(0)("RefNo")
                ...
                '共用檢核
                Dim result As RIAResult = WipUtilValidate.ChkDataOk(EditMode, 2, PRWipData, OldWip, WipCode, Facility, PrFacility, Charge, WipSystem, PRChangeFacility)
                '設備檢核錯誤碼    : -10001 ~ -19999
        ...
        Catch ex As Exception
            aRet.ErrorCode = -999
            aRet.ErrorMessage = ValidateLanguage.DataUpdateError
        End Try
        Return aRet
    End Function
    ''' <summary>
